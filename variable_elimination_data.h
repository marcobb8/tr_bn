...
//    Factor_Tree_data(const Factor_Tree_data& ft);
    ...
    std::vector<double> compute_gradient(std::vector<double> &x,std::vector<std::vector<std::shared_ptr<std::vector<std::vector<int>>>>> &indicators_vector, std::vector<std::vector<std::shared_ptr<std::vector<std::vector<int>>>>> &indicators_evidence);
    double compute_conditional_log_likelihood_function(std::vector<double> &x, std::vector<std::vector<std::shared_ptr<std::vector<std::vector<int>>>>> &indicators_vector, std::vector<std::vector<std::shared_ptr<std::vector<std::vector<int>>>>> &indicators_evidence);
