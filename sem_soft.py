...
# Tractable SEM
def tsem_cache(data_frame, et0=None, u=5, metric='bic', tw_bound_type='b', tw_bound=5,  cores=multiprocessing.cpu_count(), forbidden_parent=None, add_only = False, custom_classes=None, constraint = True, complete_prior = 'mode', alpha = 1, verbose = False):
    ...
    Returns:
        elimination_tree.ElimTree Learned elimination tree (structure+EO), learning time, c++ ET (with parameters), _
    """
